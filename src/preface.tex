...
Hisaiti Hada\({}^\ddagger\) \quad
}

% 日本語所属
\jaffiliation{
\(\dagger\) 東京工科大学 メディア学部メディア学科
...
% 英語概要
\eabstract{
Focusing on the flavor, we used the scent (retronasal) that comes in from the mouth, which is closely related.
